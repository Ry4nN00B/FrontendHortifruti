...
| GET | `/produtos` | ProductService | Retorna lista de produtos. |
| POST | `/produtos` | ProductService | Cria novo produto. |
| PUT | `/produtos/{id}` | ProductService | Atualiza um produto existente. |
| DELETE | `/produtos/{id}` | ProductService | Exclui um produto. |
| GET | `/estoque` | StockService | Retorna lotes de estoque. |
| GET | `/fornecedores` | SupplierService | Lista fornecedores. |
| POST | `/fornecedores` | SupplierService | Cadastra fornecedor. |
| PUT | `/fornecedores/{cnpj}` | SupplierService | Atualiza fornecedor. |
| DELETE | `/fornecedores/{cnpj}` | SupplierService | Exclui fornecedor. |
| GET | `/categorias` | CategoriaService | Lista categorias. |
| POST | `/categorias` | CategoriaService | Cria categoria. |
| PUT | `/categorias/{id}` | CategoriaService | Atualiza categoria. |
| DELETE | `/categorias/{id}` | CategoriaService | Exclui categoria. |
| GET | `/relatorios/financial` | ReportService | Relatório financeiro. |
| GET | `/relatorios/stock` | ReportService | Relatório de estoque. |
| GET | `/relatorios/validity` | ReportService | Relatório de validade. |
| GET | `/relatorios/history` | ReportService | Histórico de vendas. |
